            ...
            <table class="table table-hover">
              ...
              <?php while($s = $result -> fetch_assoc()){?>
                <tr>
                    ...
                    <td><?= $s['next_visit'];?></td>
                    <td>
                        <a href="ndetails.php?details=<?= $s['id']; ?>" class="badge badge-primary p-1">Details</a>
                        <a href="naction.php?delete=<?= $s['id']; ?>"class="badge badge-danger p-1"
                         onclick="return confirm('Do you want to delete this record')">Delete</a>
                        <a href="Nurse.php?edit=<?= $s['id']; ?>" class="badge badge-success p-1">Edit</a>
                        <a href="naction.php?view=<?= $s['id']; ?>" class="badge badge-success p-1">LabFile</a>
                    </td>
                </tr>
                <?php } ?>
                </tbody>
